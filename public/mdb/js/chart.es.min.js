...
const inputCallback = (component, initSelector) => {
  ...
  SelectorEngine$1.find(SELECTOR_DATA_INIT).map((element2) => new Input(element2));
...
const lightboxCallback = (component, initSelector) => {
  ...
  SelectorEngine$1.find(SELECTOR_DATA_INIT).forEach((el) => new Lightbox(el));
  EventHandler$1.on(document, EVENT_CLICK_DATA_API, SELECTOR_TOGGLE, Lightbox.toggle());
};
